...
class SettingsNotifier extends Notifier<SettingsState> {
  ...
  @override
  SettingsState build() {
    _prefs = ref.read(sharedPrefsInternalProvider);
    return SettingsState(
...
/// Internal provider so SettingsNotifier can access SharedPreferences.
/// Overridden in providers.dart.
final sharedPrefsInternalProvider = Provider<SharedPreferences>((_) {
